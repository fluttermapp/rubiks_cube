...
import 'package:rubbik/solve.dart';
import 'package:rubbik/state/data_state.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  bool loading = false;
  final server_url = "http://142.117.187.5:5000/"; //change your URL or local IP
  ...
  Future getImage(String side) async {
    ...
    final pickedFile = await picker.getImage(
        source: ImageSource.gallery, maxHeight: 1600, maxWidth: 1000);
